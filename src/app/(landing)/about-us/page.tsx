    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-10">
      <div className="max-w-4xl bg-white rounded-lg p-6 md:p-10">
        ...
        <p className="text-sm lg:text-base text-gray-600 leading-relaxed mb-4">
          <strong>کارت خانه</strong> یک اپلیکیشن نوآورانه است که به منظور
          ساده‌تر کردن زندگی روزمره طراحی شده است. هدف ما ایجاد بستری امن، راحت
          و کاربرپسند است که مدیریت وظایف، سازماندهی اطلاعات، و دسترسی به
          اطلاعات کارت های بانکی خود را برای شما تسهیل می‌کند.
        </p>
        <p className="text-sm lg:text-base text-gray-600 leading-relaxed mb-4">
        ...
        <p className="text-sm lg:text-base text-gray-600 leading-relaxed mt-6">
          ...
          گونه تهدیدی محافظت می‌کنیم. علاوه بر این، ما همیشه شفافیت کامل را در
          مورد نحوه استفاده از داده‌هایمان به شما ارائه می‌دهیم.
        </p>
        <p className="text-sm lg:text-base text-gray-600 leading-relaxed mt-6">
